...
export class DrawingClass {
    ...
    constructor(HTMLHandler: HTMLHandler, soundController: SoundController) {
        ...
        this.Rtype = new TypeObject("Rtype", "add, addu, sub, subu, and, or, slt, sltu".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.regDst.bind(this), this.aluOp.bind(this), this.ALUcontrol.bind(this), this.regWrite.bind(this), this.instruction2521.bind(this), this.instruction2016.bind(this), this.instruction2016_1.bind(this), this.instruction1511.bind(this), this.drawMUX1511.bind(this), this.muxToWriteRegister.bind(this), this.registers.bind(this), this.readData1.bind(this), this.readData2.bind(this), this.muxALU.bind(this), this.muxALUtoALUBottom.bind(this), this.instruction150.bind(this), this.instruction50.bind(this), this.aluControlToAluBottom.bind(this), this.aluBottom.bind(this), this.fromALUResult.bind(this), this.toMuxBottomRight.bind(this), this.bottomRightMux.bind(this), this.bottomRightMuxToWriteData.bind(this)], "10",
            ["1", "0", "X", "1", "0", "0", "0", "10", "0"]);//RegDst RegWr ALUOp
        this.Itype = new TypeObject("Itype", "addi, addiu, andi, slti, sltiu, ori".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.aluOp.bind(this), this.ALUcontrol.bind(this), this.aluSrc.bind(this), this.regWrite.bind(this), this.instruction2521.bind(this), this.instruction2016.bind(this), this.draw2016toMUX.bind(this), this.drawMUX1511.bind(this), this.muxToWriteRegister.bind(this), this.registers.bind(this), this.readData1.bind(this), this.instruction150.bind(this), this.signExtended.bind(this), this.signExtendToShiftLeftBottom.bind(this), this.signExtendToMUX.bind(this), this.muxALU.bind(this), this.muxALUtoALUBottom.bind(this), this.aluControlToAluBottom.bind(this), this.aluBottom.bind(this), this.fromALUResult.bind(this), this.toMuxBottomRight.bind(this), this.bottomRightMux.bind(this), this.bottomRightMuxToWriteData.bind(this)], "10",
            ["0", "1", "X", "1", "0", "0", "0", "10", "0"]);
        this.lw = new TypeObject("lw", "lw, lb".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.memRead.bind(this), this.memToReg.bind(this), this.aluOp.bind(this), this.ALUcontrol.bind(this), this.aluSrc.bind(this), this.regWrite.bind(this), this.instruction2521.bind(this), this.instruction2016.bind(this), this.draw2016toMUX.bind(this), this.drawMUX1511.bind(this), this.muxToWriteRegister.bind(this),  this.registers.bind(this), this.readData1.bind(this), this.instruction150.bind(this), this.signExtended.bind(this), this.signExtendToShiftLeftBottom.bind(this), this.signExtendToMUX.bind(this), this.muxALU.bind(this), this.muxALUtoALUBottom.bind(this), this.aluControlToAluBottom.bind(this), this.aluBottom.bind(this), this.fromALUResult.bind(this), this.ALUbottomToAddress.bind(this), this.dataMemory.bind(this), this.readDataToMuxBottomRight.bind(this), this.bottomRightMux.bind(this), this.bottomRightMuxToWriteData.bind(this)], "00",
            ["0", "1", "1", "1", "1", "0", "0", "00", "0"]);//ALUSrc MEMReg RegWr MemRd
        this.sw = new TypeObject("sw", "sw, sb".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.aluSrc.bind(this), this.memWrite.bind(this), this.aluOp.bind(this), this.ALUcontrol.bind(this), this.instruction2521.bind(this), this.instruction2016.bind(this), this.instruction2016_1.bind(this), this.registers.bind(this), this.readData1.bind(this),this.instruction150.bind(this), this.signExtended.bind(this), this.signExtendToShiftLeftBottom.bind(this), this.signExtendToMUX.bind(this), this.muxALU.bind(this), this.muxALUtoALUBottom.bind(this), this.aluControlToAluBottom.bind(this), this.aluBottom.bind(this), this.fromALUResult.bind(this), this.ALUbottomToAddress.bind(this), this.readData2ToWriteData.bind(this), this.dataMemory.bind(this)], "00",
            ["x", "1", "X", "0", "0", "1", "0", "00", "0"]);
        this.beq = new TypeObject("beq", "beq, ".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.branch.bind(this), this.aluOp.bind(this), this.ALUcontrol.bind(this), this.instruction2521.bind(this), this.instruction2016.bind(this), this.instruction2016_1.bind(this), this.registers.bind(this), this.readData1.bind(this), this.readData2.bind(this), this.muxALU.bind(this), this.muxALUtoALUBottom.bind(this), this.aluControlToAluBottom.bind(this), this.aluBottom.bind(this), this.zeroToHalfCircle.bind(this), this.HalfCircle.bind(this), this.halfCircleToMux.bind(this), this.instruction150.bind(this), this.signExtended.bind(this), this.signExtendToShiftLeftBottom.bind(this), this.toShiftLeft2.bind(this),this.shiftLeftBottom.bind(this), this.shiftLeft2ToALUTop.bind(this),this.toADD.bind(this), this.add4.bind(this), this.drawADD.bind(this), this.addToMux_1.bind(this), this.aluTop.bind(this), this.topALUToMux.bind(this), this.halfCircleMUX.bind(this), this.muxToMux.bind(this), this.topRightMUX.bind(this), this.MuxToPC.bind(this)], "01",
            ["X", "0", "X", "0", "0", "0", "1", "01", "0"]);//branch ALUOp = 01
        this.j = new TypeObject("j", "j, ".split(", "), [this.PC.bind(this), this.fromPC.bind(this), this.readAddress.bind(this), this.fromReadAddress.bind(this), this.instruction3126.bind(this), this.drawControl.bind(this), this.jump.bind(this), this.instruction250.bind(this), this.shiftLeft2.bind(this), this.fromJumpAddress.bind(this), this.toADD.bind(this), this.add4.bind(this), this.drawADD.bind(this), this.addToJumpAddress.bind(this), this.jumpAddress310.bind(this), this.topRightMUX.bind(this), this.MuxToPC.bind(this)], "XX",
            ["X", "X", "X", "0", "0", "0", "X", "XX", "1"]);//JumpI
    ...
    runInstruction(instruction: string, time: number): number {
        ...
        // this.animator.aniamte(function () { this.draw(this.Rtype) }.bind(this), 3000 * i)
    ...
    instruction2016(stringALU: string, instruction3126: string, instruction2521: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    instruction2521(stringALU: string, instruction3126: string, instruction2521: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    instruction3126(stringALU: string, instruction3126: string, instruction2531: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    instruction1511(stringALU: string, instruction3126: string, instruction2521: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    instruction150(stringALU: string, instruction3126: string, instruction2521: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    instruction250(stringALU: string, instruction3126: string, instruction2521: string,
        instruction2016: string, instruction1511: string, instruction150: string, instruction250: string) {
    ...
    drawMUX1511() {
        ...
        this.brush.strokeRect(0.308 * this.canvas.width, 0.610 * this.canvas.height,
            0.035 * this.canvas.width, 0.137 * this.canvas.height);

        this.brush.fillText("0", 0.318 * this.canvas.width, 0.645 * this.canvas.height);//x
        this.brush.fillText("M", 0.318 * this.canvas.width, 0.670 * this.canvas.height);//x+9
        this.brush.fillText("u", 0.318 * this.canvas.width, 0.691 * this.canvas.height);//x+16
        this.brush.fillText("x", 0.318 * this.canvas.width, 0.710 * this.canvas.height);//x+24
        this.brush.fillText("1", 0.318 * this.canvas.width, 0.733 * this.canvas.height);//x+34
    }
    ...
    muxToWriteRegister() {
        ...
        if (this.audio) this.soundController.playSound(ttsConfig.muxToWriteRegister);
    ...
    ALUcontrol() {
        ...
        //if (this.audio) this.soundController.playSound(ttsConfig.ALUcontrol);
    ...
    muxALU() {
        ...
        this.brush.fillText("0", 0.540 * this.canvas.width, 0.640 * this.canvas.height);//x
        this.brush.fillText("M", 0.540 * this.canvas.width, 0.665 * this.canvas.height);//x+9
        this.brush.fillText("u", 0.540 * this.canvas.width, 0.686 * this.canvas.height);//x+16
        this.brush.fillText("x", 0.540 * this.canvas.width, 0.706 * this.canvas.height);//x+24
        this.brush.fillText("1", 0.540 * this.canvas.width, 0.728 * this.canvas.height);//x+34
    ...
    ALUbottomToAddress() {
        ...
        if (this.audio) this.soundController.playSound(ttsConfig.ALUbottomToAddress);
    ...
    readDataToMuxBottomRight() {
        ...
        if (this.audio) this.soundController.playSound(ttsConfig.readDataToMuxBottomRight);
    ...
    bottomRightMux() {
        ...
        this.brush.strokeRect(0.906 * this.canvas.width, 0.590 * this.canvas.height,
    ...
    bottomRightMuxToWriteData() {
        ...
        if (this.audio) this.soundController.playSound(ttsConfig.bottomRightMuxToWriteData);
    ...
    signExtendToShiftLeftBottom() {
        ...
        if (this.audio) this.soundController.playSound(ttsConfig.signExtendToShiftLeftBottom);
    ...
    shiftLeftBottom() {
        ...
        ///if (this.audio) this.soundController.playSound(ttsConfig.shiftLeftBottom);
    ...
    halfCircleMUX() {
        ...
        this.brush.strokeRect(0.807 * this.canvas.width, 0.093 * this.canvas.height,
            0.028 * this.canvas.width, 0.137 * this.canvas.height);
    ...
    drawFrame(func: Function, stringALU: string, type: string, instructionAndArguments: string[]) {
        ...
        if (type == "Itype" || type == "beq") {
            ...
            instruction2016 = instructionAndArguments[1]; // might need to switch 2 and 1
            instruction1511 = "";
    ...
    drawDefault() {
        ...
        // this.draw(new TypeObject("", [], [], "", [])); // i know this isnt the best way to do this but sorry
        this.setUpCanvas();
    }
