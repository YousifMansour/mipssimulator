export class HTMLHandler {
  ...
  binHexButton: HTMLButtonElement;
  ...
  constructor() {
    this.binHexButton =
        <HTMLButtonElement>document.getElementById('binHexButton');
    this.changeColorButton =
        <HTMLButtonElement>document.getElementById('changeColorButton');
    this.changeSpeedButton =
        <HTMLButtonElement>document.getElementById('changeSpeedButton');
    this.speedDropDownMenu =
        <HTMLDirectoryElement>document.getElementById('speedDropDown-content');
    this.colorDropDownContent =
        <HTMLDivElement>document.getElementById('colorDropDown-content');
    this.detailedTable =
        <HTMLTableElement>document.getElementById('detailedTable');
    this.fullScreenButton =
        <HTMLButtonElement>document.getElementById('fullScreenButton');
    this.colorButton =
        <HTMLButtonElement>document.getElementById('colorDropDownMenu');
    this.previousButton =
        <HTMLButtonElement>document.getElementById('previousButton');
    ...
    this.normalButton =
        <HTMLButtonElement>document.getElementById('normalButton');
    ...
    this.soundButton =
        <HTMLButtonElement>document.getElementById('soundButton');
    ...
    this.registersTable =
        <HTMLTableElement>document.getElementById('registersTable');

    this.instructionAndArguments =
    ...
    this.changeThemeButton =
        <HTMLButtonElement>document.getElementById('changeThemeButton');
  ...
  toggleSound() {
    ...
    if (this.body.style.background != 'white') {
      if (this.isSoundOn)
        this.soundButton.style.backgroundImage =
            'url(\'./res/soundButton.png\')';
      else
        this.soundButton.style.backgroundImage =
            'url(\'./res/nosoundButton.png\')';
    } else {
      if (this.isSoundOn)
        this.soundButton.style.backgroundImage =
            'url(\'./res/soundButton_black.png\')';
      else
        this.soundButton.style.backgroundImage =
            'url(\'./res/nosoundButton_black.png\')';
    }
  }
  ...
  fullScreenMode(boolean: boolean) {
    ...
    if (boolean) {
      ...
      if (this.body.style.background != 'white')
        this.fullScreenButton.style.backgroundImage =
            'url(\'./res/nofullscreen.png\')';
      else
        this.fullScreenButton.style.backgroundImage =
            'url(\'./res/nofullscreen_black.png\')';
      ...
      if (this.body.style.background != 'white')
        this.fullScreenButton.style.backgroundImage =
            'url(\'./res/fullscreen.png\')';
      else
        this.fullScreenButton.style.backgroundImage =
            'url(\'./res/fullscreen_black.png\')';
  ...
  emptyDetailedTable() {
    this.updateDetailedTable('_', [
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '
    ]);  // gives an empty controll signal[]
  }

  updateDetailedTable(instruction: string, controlSingals: string[]) {
    if (controlSingals == undefined && instruction == undefined) return;

    (<HTMLTableRowElement>document.getElementById('instructionIndicator'))
        .innerHTML = instruction;

    (<HTMLTableRowElement>document.getElementById('RegDst')).innerHTML =
        controlSingals[0];
    (<HTMLTableRowElement>document.getElementById('AluSrc')).innerHTML =
        controlSingals[1];
    (<HTMLTableRowElement>document.getElementById('MemReg')).innerHTML =
        controlSingals[2];
    (<HTMLTableRowElement>document.getElementById('RegWr')).innerHTML =
        controlSingals[3];
    (<HTMLTableRowElement>document.getElementById('MemRd')).innerHTML =
        controlSingals[4];
    (<HTMLTableRowElement>document.getElementById('MemWr')).innerHTML =
        controlSingals[5];
    (<HTMLTableRowElement>document.getElementById('Branch')).innerHTML =
        controlSingals[6];
    (<HTMLTableRowElement>document.getElementById('AluOp')).innerHTML =
        controlSingals[7];
    (<HTMLTableRowElement>document.getElementById('Jump')).innerHTML =
        controlSingals[8];
  ...
  hideTextArea() {
    ...
    if (this.body.style.background == 'white') {
      ...
      this.instructionAndArguments.style.background =
  ...
  showPreviousButton() {
    ...
    if (this.body.style.background != 'white')
      ...
      this.previousButton.style.backgroundImage =
          'url(\'./res/previous_black.png\')';
  }

  hidePreviousButton() {
    this.previousButton.setAttribute('disabled', 'true');
    this.previousButton.style.backgroundImage =
        'url(\'./res/previousDisabled.png\')';
  }
