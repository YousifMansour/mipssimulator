...
export class ThemeManager {
  ...
  constructor(
      htmlHandler: HTMLHandler, drawingObject: DrawingClass, mipsObject: MIPS) {
  ...
  changeToWhiteTheme() {
    ...
    this.htmlHandler.runButton.style.backgroundImage =
        'url(\'./res/play_black.png\')';
    this.htmlHandler.nextButton.style.backgroundImage =
        'url(\'./res/next_black.png\')';
    this.htmlHandler.previousButton.style.backgroundImage =
        'url(\'./res/previous_black.png\')';
    if (this.htmlHandler.previousButton.getAttribute('disabled'))
      this.htmlHandler.previousButton.style.backgroundImage =
          'url(\'./res/previousDisabled.png\')';
    this.htmlHandler.fullScreenButton.style.backgroundImage =
    ...
    this.htmlHandler.editButton.style.backgroundImage =
        'url(\'./res/edit_black.png\')';
    this.htmlHandler.github.src = './res/github_white.png';

    if (this.htmlHandler.editButton.getAttribute('disabled'))
      this.htmlHandler.editButton.style.backgroundImage =
          'url(\'./res/editDisabled.png\')';

    if (this.htmlHandler.isSoundOn)
      this.htmlHandler.soundButton.style.backgroundImage =
    ...
    this.htmlHandler.detailedTable.style.borderColor =
        'black'
    ...
    this.htmlHandler.instructionAndArguments.style.background =
        this.htmlHandler.textArea.style.background;
    ...
    this.htmlHandler.binHexButton.style.background = 'white';
    this.htmlHandler.binHexButton.style.color = 'black';
  ...
  changeToBlackTheme() {
    ...
    this.htmlHandler.binHexButton.style.background = '#171717';
    this.htmlHandler.binHexButton.style.color = 'white';
